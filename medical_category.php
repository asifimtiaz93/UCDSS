...
<div id="page">
	<div id="page-bgtop">
		<div id="page-bgbtm">
			<div id="content">
				<div class="post">
				    <h1> Medical Category Information </h1> </br>
                    
                        <form action="" method="post">
                        <input type="text" name="soldier_id" id="soldier_id" placeholder="Search by Soldier ID">
                        
                        <select name="medical_category" id="medical_category">
                        ...
                        <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                $query = "
                                select Sldr_ID, Rank, Sldrs_basic_info.Name, Med_Cat 
