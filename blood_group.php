...
<div id="page">
	<div id="page-bgtop">
		<div id="page-bgbtm">
			<div id="content">
				<div class="post">
				    <h1>Blood Group Information </h1> </br>
                    <form action="" method="post">
                        <label for="blood_gp">Choose a BLood Group:</label>
                        <select name="blood_gp" id="blood_gp">
                            <option value="">Select Blood Gp</option>
                        ...
                        <label for="soldier_id">Soldier_ID:</label>
                        <input type="number" name="soldier_id" id="soldier_id" placeholder="Soldier ID">
                    ...
                    <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if (!empty($blood_gp)) {
                                   $query .= " AND BlOOD_GROUP = '" . $blood_gp . "'";
                                }
