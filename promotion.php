				...
				<div class="post">
                    ...
                    <div>
                         ...
                         <form action="" method="post">
                            ...
                            <select name="promotion_rank" id="promotion_rank">
                                <option value="">Select Promotion Rank</option>
                                <option value="snk_to_lcpl">Sainik to LCpl</option>
                                <option value="lcpl_to_cpl">Lcpl to Cpl</option>
                                <option value="cpl_to_sgt">Cpl to Sgt</option>
                            </select>
                        ...
                        <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
								...
								$selectedOption = $_POST['promotion_rank'];

								if ($selectedOption === 'snk_to_lcpl') {
									// Run query for 'snk_to_lcpl' option
									$query = "select DISTINCT SLDRS_BASIC_INFO.SLDR_ID, RANK.RANK,  Sldrs_Basic_Info.NAME, UNDERTAKES.RESULT, UNDERTAKE_RET.RESULT, SLDRS_BASIC_INFO.SVC_AGE
									...
									// ...
								} elseif ($selectedOption === 'lcpl_to_cpl') {
									// Run query for 'lcpl_to_cpl' option
									$query = "select DISTINCT SLDRS_BASIC_INFO.SLDR_ID as SLDR_ID, RANK.RANK,  Sldrs_Basic_Info.NAME, UNDERTAKES.RESULT, UNDERTAKE_RET.RESULT, SLDRS_BASIC_INFO.SVC_AGE
									from Sldrs_Basic_Info, Rank, Punishment, Awarded, RET, Undertake_RET, IPFT, Undertakes, courses, completes_course 
									where Rank.Rank_ID=Sldrs_basic_info.Rank_ID and
									Undertake_RET.Soldier_ID=Sldrs_basic_info.Sldr_ID and
									Undertake_RET.RET_ID= RET.RET_ID and
									...
									// Execute the query and process the results
									// ...
								} elseif ($selectedOption === 'cpl_to_sgt') {
									// Run query for 'cpl_to_sgt' option
									$query = "select DISTINCT SLDRS_BASIC_INFO.SLDR_ID, RANK.RANK,  Sldrs_Basic_Info.NAME, UNDERTAKES.RESULT, UNDERTAKE_RET.RESULT, SLDRS_BASIC_INFO.SVC_AGE
									from Sldrs_Basic_Info, Rank, Punishment, Awarded, RET, Undertake_RET, IPFT, Undertakes, courses, completes_course 
									where Rank.Rank_ID=Sldrs_basic_info.Rank_ID and
									Undertake_RET.Soldier_ID=Sldrs_basic_info.Sldr_ID and
                                ...
                                while ($row = oci_fetch_assoc($result)) {
                                    echo "<tr>
                                        ...
                                        <td>" . $row['RESULT'] . "</td>
                                        <td>" . $row['SVC_AGE'] . "</td>
										<td><button type='submit' name='promote_button' value='" . $row['SLDR_ID'] . "'>Promote</button></td> <!-- Button column -->
