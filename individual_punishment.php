...
<div id="page">
    ...
    <option value="7 Days RI">7 Days RI</option>
    <option value="10xDays RI">10xDays RI</option>
    <option value="07xDays RI">07xDays RI</option>
    <option value="07XDays RI">07XDays RI</option>
    <option value="nil">nil</option>
                        ...
                        <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if (!empty($punishment)) {
                                    $query .= " AND PUNISHMENT = '" . $punishment . "'";
                                }
