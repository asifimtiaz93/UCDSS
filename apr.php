...
<div id="page">
	<div id="page-bgtop">
		<div id="page-bgbtm">
			<div id="content">
				<div class="post">
				    <h1> APR Information </h1> </br>
                    <form action="" method="post">
                        <input type="text" name="soldier_id" id="soldier_id" placeholder="Search by Soldier ID"></br>
                        <label for="apr_from">APR Score From:</label><br />
                        <input type="number" name="apr_from" id="apr_from" placeholder="apr From"></br>
                        <label for="apr_to">APR Score To:</label><br />
                        <input type="number" name="apr_to" id="apr_to" placeholder="apr To">
                        ...
                        <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                $apr_from = $_POST['apr_from'];
                                $apr_to = $_POST['apr_to'];
                                

                                // Build the query based on the provided inputs
                                $query = "
                                select Sldr_ID, Rank, Sldrs_basic_info.Name, LAST_OPR_MKS 
                                ...
                                if (!empty($apr_from)) {
                                    $query .= " AND LAST_OPR_MKS >= " . $apr_from;
                                }
                                if (!empty($apr_to)) {
                                    $query .= " AND LAST_OPR_MKS <= " . $apr_to;
                                }
