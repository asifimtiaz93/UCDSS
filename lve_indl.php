...
<div id="page">
	<div id="page-bgtop">
		<div id="page-bgbtm">
			<div id="content">
				<div class="post">
				    <h1> Leave Information </h1> </br>
                    
                    <div>
                        <h3>Indiviual Leave state</h3>
                        ...
                        <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                $query = "
                                select Sldr_ID, Rank, Sldrs_basic_info.Name, Total_Leave, LEAVE_TYPE, SUM(Total_Leave) OVER (PARTITION BY Sldr_ID) as T_LEAVE
