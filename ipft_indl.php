		...
		<div id="page-bgbtm">
			<div id="content">
				<div class="post">
                    ...
                    <div>
                        <h3>Indiviual IPFT state</h3>
                         <form action="" method="post">
                            <input type="number" name="soldier_id" id="soldier_id" placeholder="Search by Soldier ID">
                            <input type="text" name="soldier_name" id="soldier_name" placeholder="Search by Soldier Name">
                            <select name="ipft_status" id="ipft_status">
                        ...
                        <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                $soldierName = $_POST['soldier_name'];
                                $ipft_status = $_POST['ipft_status'];

                                // Build the query based on the provided inputs
                                $query = "
                                select Sldr_ID, Rank, Sldrs_basic_info.Name, Result, Year, Period
                                from Sldrs_Basic_Info, Rank, IPFT,  Undertakes 
                                where Rank.Rank_ID=Sldrs_basic_info.Rank_ID and  
                                Undertakes.Soldier_ID=Sldrs_basic_info.Sldr_ID and
                                Undertakes.IPFT_ID=IPFT.IPFT_ID
                                ...
                                if (!empty($ipft_status)) {
                                    $query .= " AND RESULT = '" . $ipft_status . "'";
                                }

                                if(!empty($soldierName)){
                                    
                                    $query .= " AND Name LIKE '%" . $soldierName . "%'";
